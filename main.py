...
keywords = ["Person Re-ID", "Image Editing","Text based person retrieval", "Clothes Changing Person ReID","Virtual Try-On", "try on", "low level vision"] # TODO add more keywords
...
f_is.write("---\n")
f_is.write("**Please check the [Github](https://github.com/lyx-JuneSnow/DailyArxiv) page for a better reading experience and more papers.**\n\n")
